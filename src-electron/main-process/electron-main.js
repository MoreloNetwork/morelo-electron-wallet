...
if (process.env.PROD) {
    ...
    global.__morelo_bin = path.join(__dirname, "..", "bin").replace(/\\/g, "\\\\")
} else {
    global.__morelo_bin = path.join(process.cwd(), "bin").replace(/\\/g, "\\\\")
}
